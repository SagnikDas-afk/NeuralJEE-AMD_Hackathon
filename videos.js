(function(){
  ...
  t.innerHTML=`<!-- VIDEOS PAGE -->
<div id="page-videos" class="page">
  <div class="ph">
    <h1>▶️ Video Library</h1>
  ...
  <div class="vtabs-row">
    ...
    <button class="vtab" id="vtab-library" onclick="setVidSection('library',this)">
      📚 JEE Library <span class="vtab-count">0</span>
    </button>
    <button class="vtab" id="vtab-mine" onclick="setVidSection('mine',this)">
      📁 My Videos <span class="vtab-count">0</span>
    </button>
  ...
  <div class="vid-controls-row">
    ...
    <div class="subj-filters" style="margin:0;flex-wrap:nowrap;">
      ...
      <button class="f-btn" onclick="filterVids('physics',this)" style="color:var(--physics)">⚛️ Physics</button>
      <button class="f-btn" onclick="filterVids('chemistry',this)" style="color:var(--chemistry)">🧪 Chemistry</button>
    ...
    <div class="modal-box" style="max-width:820px;">
      ...
      <div id="vp-fallback" style="display:none;padding:40px 24px;text-align:center;background:var(--surface2);">
        ...
        <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;">
          ...
          <button onclick="toggle✅ Watched(currentPlayingVidId);showToast('Marked as watched!')" style="padding:12px 22px;background:rgba(127,255,106,.1);border:1px solid rgba(127,255,106,.3);border-radius:8px;color:var(--accent3);font-size:14px;font-weight:700;cursor:pointer;font-family:'Syne',sans-serif;">&#x2705; Mark✅ Watched</button>
        </div>
      </div>
      ...
      <div style="padding:12px 18px;border-top:1px solid var(--border);display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
        <button class="btn-sec" onclick="mark✅ Watched()" id="watch-btn" style="font-size:12px;">&#x2705; Mark as✅ Watched</button>
